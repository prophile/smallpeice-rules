...
\begin{tabular}{lcc}
  ...
  Poison token & 18 & 250 \\
  Silver tokens & 19 -- 38 & 100 \\
  Gold tokens & 39 -- 58 & 100 \\
...
\begin{enumerate}
  ...
  \item The scoring zones are rectangles, the full width of the arena,
        extending into the arena by \SI{1.5}{m}.
  \item In the centre of the arena are shelves raised by \SI{120}{mm}
        (tolerance $\pm$ \SI{30}{mm}) above the arena floor. They are
        \SI{0.5}{m} deep and \SI{1}{m} wide.
