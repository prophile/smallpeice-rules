...
with a particular feature in the arena, and also has an associated size. The
marker numbers and sizes are as follows:
...
\begin{enumerate}
  ...
  \item In the centre of the arena is a central reservation raised by
        at least \SI{150}{mm} ) above the arena floor. It is rectangular, and
        sized such that the width of the track is \SI{1.2}{mm}.
...
\begin{enumerate}
  \item Tokens are steel cans. Size and weight TBD.
